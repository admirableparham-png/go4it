...
(function () {
  ...
  panel.style.cssText =
    ...
    "border:1px solid #334155;min-width:200px";
  panel.innerHTML =
  ...
  function extractLeads() {
    const leads = [];
    // Placeholder: replaced with exact selectors once the tuning page arrives.
    // Until then this returns [] and the "Capture" button reports 0.
    return leads;
  }
